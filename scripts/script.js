...
var playerWinnerMessage = "Well done, you secured the system";
...
function compareCards(){
  ...
  document.querySelector("button.next-turn").removeAttribute("enabled");
}
...
function restartGame(){
  ...
  document.querySelector("button").removeAttribute("enabled");
...
function playTurn() {
  ...
  document.querySelector(".next-turn").setAttribute("enabled", "true");
...
function revealCards(){
  ...
  var randomScenarioIndex = Math.floor(0 * scenarios.length);
